...
/// <summary>Configures the buff-in-town behavior: when to buff and with which skills</summary>
public sealed record BuffConfig
{
    /// <summary>Case-insensitive substring that triggers a buff when overheard in chat</summary>
    public string Trigger { get; init; } = "buff";

    /// <summary>Skill IDs to cast, in order, on the target</summary>
